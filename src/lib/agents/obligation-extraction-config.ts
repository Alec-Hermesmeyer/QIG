// obligation-extraction-config.ts
// Obligation Analysis configuration using shared types

import { ObligationAnalysisConfig } from './types';

// Export the obligation analysis configuration
const obligationExtractionConfig: ObligationAnalysisConfig = {
