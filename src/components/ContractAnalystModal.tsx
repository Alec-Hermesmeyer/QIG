...
const ContractAnalysisModal: React.FC<ContractAnalysisModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-transparent bg-opacity-50 z-50 flex items-center justify-center overflow-y-scroll">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-6xl m-4 max-h-[90vh] flex flex-col">
        {/* Modal header */}
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-xl font-bold">Contract Risk Assessment</h2>
          <button 
            onClick={onClose}
