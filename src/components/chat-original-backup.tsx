...
// Wake words and action words for hands-free mode
...
export const ImprovedChat = forwardRef<ImprovedChatHandle, ChatProps>(function ImprovedChat(
  ...
  // Voice state - simplified to use new voice service
  ...
  // Text-to-speech state - simplified
  const [isPlaying, setIsPlaying] = useState(false);
  const [audioSrc, setAudioSrc] = useState<string | null>(null);
  const audioRef = useRef<HTMLAudioElement | null>(null);
  
  // Voice recording refs - simplified for new voice service
